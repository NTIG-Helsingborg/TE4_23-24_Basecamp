...
<body id="indexBackground">
	 <header>
		<!-- NAVBAR -->
<nav class="navbar navbar-expand-md navbarBG navbar-dark ">
...
<div class="caption text-center video-text">
	...
	<h3>Lorem ipsum dolor sit amet, consectetur adipiscing elit
		eiusmod tempor incididunt ut labore et dolore magna aliqua. Duis aute irure dolor in reprehenderit in voluptate
	</h3>
</div>
...
<div class="container">
	...
	<section>
		<div class="row" id="">
			<div class="col-sm-6"> 
				<img src="Images/coding.jpg" class="img-thumbnail" alt="Code" width="200px" class="img-fluid animated fadeInLeft" >
			</div>	
			<div class="col-sm-6">
				<h4 class="text-center">Gemenskap</h4>
				<hr class="bg-light mx-auto" style="width: 100px; height: 2px">
				<p class="mr-auto">>Lorem ipsum eiusmod tempor incididunt ut labore et dolore magna aliqua. Duis aute irure dolor in reprehenderit in voluptate orem ipsum eiusmod tempor incididunt ut labore et dolore magna aliqua</p>
			</div>
		</div>
	</section>
	<br> <br> <br> <br>
